 ...
 * to reconstruct the allowance status for all accounts just by listening to
 * said events. Note that this isn't required by the specification, and other
...
contract ERC20 is IERC20 {
  ...
  */
   ...
   * behalf of msg.sender. Beware that changing an allowance with this method
   * brings the risk that someone may use both the old and the new allowance by
   ...
   * as per the specification, and other compliant implementations may not emit
   * the event.
